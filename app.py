...
def predict():
    ...
    # sh = sa.open("iit-and-nit-colleges-admission-criteria-version-2")
    # print("ok")
    ...
    return render_template("home.html", prediction_College = "College : {}".format(output[0]) ,prediction_Degree = "Degree : {}".format(output[1]) ,prediction_Course =  "Course : {}".format(output[2]), prediction = "Thank you, Hope this will match your requirement !!!")
